...
#include <thread>
#include <chrono>
//This library is for colour addition
#include<windows.h>
using namespace std;

//FUNCTION 10
//I took AI guidance for this exact function
...
int main() {
    ...
    setColor(3); // Purple for intro msg
    cout << "\n_________Welcome to the Sudoku Game_________\n";
    setColor(7); // Reset the colour to white again for next lines of code.
    int size;
    do {
        setColor(6); //Yellow for this line
   ...
   setColor(3);
    ...
    while (!gameOver) {
        ...
        setColor(7);
         ...
         cout<<" | Mistakes: " << mistakes << "/" << maxMistakes << "\n";
         setColor(7);
